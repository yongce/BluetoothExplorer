...
import me.ycdev.android.bluetooth.ble.client.ClientState.DISCONNECTING
import me.ycdev.android.bluetooth.ble.internal.BleGattHelperBase
import me.ycdev.android.bluetooth.ble.internal.BleGattHelperBase.Operation.CONFIG_MTU
import me.ycdev.android.bluetooth.ble.internal.BleGattHelperBase.Operation.DISCOVERY_SERVICES
import me.ycdev.android.bluetooth.ble.internal.BleGattHelperBase.Operation.READ_CHARACTERISTIC
...
internal class BleCentralHelper(val context: Context, val contract: Contract) : BleGattHelperBase() {
    ...
    private fun checkDeviceLocked(gatt: BluetoothGatt): BluetoothGatt {
        val curGatt = this.gatt ?: throw BluetoothException(
